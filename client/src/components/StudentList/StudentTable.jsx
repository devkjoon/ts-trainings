...
const StudentTable = ({ students, courses, handleShowAssignModal, handleShowEditModal, handleDeleteStudent, handleSendLoginCode }) => {
                                  ...
                                  <td className='actions-cell'>
                                    <Row>
                                      ...
                                      <Col>
                                        ...
                                        onClick={() => handleSendLoginCode(student._id, student.email)}>
                                        Send Login Code
                                      </Button>
                                      </Col>
                                    </Row>
