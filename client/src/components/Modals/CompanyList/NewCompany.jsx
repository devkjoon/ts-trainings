            ...
            <Form.Group as={Col} lg="2" md="2" className="mb-2 mt-2">
              ...
              <InputGroup className="company-input">
                <Form.Control
                  ...
                  value={companyState}
                  onChange={(e) =>
                    setCompanyState(e.target.value.replace(/[^a-zA-Z]/g, '').slice(0, 2))
                  }
                  required
                  pattern="[a-zA-Z]{2}"
                />
            ...
            <Form.Group as={Col} lg="4" className="mb-2 mt-2">
              ...
              <InputGroup className="company-input">
                <Form.Control
                  ...
                  onChange={(e) =>
                    setCompanyContactName(e.target.value.replace(/[^a-zA-Z\s]/g, ''))
                  }
                  required
                  pattern="[a-zA-Z\s]+"
                />
            ...
            <Form.Group as={Col} lg="4" className="mb-2 mt-2">
              ...
              <InputGroup className="company-input">
                <Form.Control
                  ...
                  onChange={(e) =>
                    setCompanyContactPhone(e.target.value.replace(/\D/g, '').slice(0, 10))
                  }
                  required
                  pattern="\d{10}"
                />
